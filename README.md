...
|transfer-repos.ps1| Transfers repositories from one GitHub organization to another.|`.\scripts\transfer-repos.ps1 -SourceOrg my-github-org -TargetOrg my-other-github-org -ReposFile .\repos.csv [-SourceToken <SOURCE_TOKEN>] [-TargetToken <TARGET_TOKEN>]`|
